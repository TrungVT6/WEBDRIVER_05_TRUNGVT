  ...
  public void TC_01_selectCustomDropdownList() throws Exception {
    ...
    Assert.assertTrue(driver
        .findElement(By.xpath(
            "//span[@id='number-button']//span[@class='ui-selectmenu-text' and text()='19']"))
        .isDisplayed());
    ...
    Assert.assertTrue(
        driver.findElement(By.xpath("//div[@class='mat-select-value']//span[text()='Pizza']"))
            .isDisplayed());

    selectCustomDropdownList("//mat-select[@id='mat-select-5']", "//mat-option/span", "Idaho");
    Assert.assertTrue(
        driver.findElement(By.xpath("//div[@class='mat-select-value']//span[text()='Idaho']"))
            .isDisplayed());
  }
