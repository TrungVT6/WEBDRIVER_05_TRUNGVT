...
public class Topic_02_Xpath_Css_Locator {
  ...
  public void TC_03_LoginWithPassworkLessThan6Characters() {
    ...
    String passwordIncorectMessage =
        driver.findElement(By.id("advice-validate-password-pass")).getText();
    Assert.assertEquals(passwordIncorectMessage,
  ...
  public void TC_04_CreateAnAccount() throws InterruptedException {
    ...
    driver.findElement(By.id("email_address"))
        .sendKeys("Automation" + randomEmail() + "@gmail.com");
    ...
    String registerSuccessMessage = driver
        .findElement(By.xpath(".//*[@id='top']//span[contains(text(), 'Thank you')]")).getText();
